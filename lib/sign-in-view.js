...
export default class SignInView {
  ...
  initialize (callback) {
    ...
    $(this.passwordInput.getModel().element.rootElement).find('div.lines').addClass('password-lines');
    this.passwordInput.getModel().onDidChange(function(){
      ...
      var passwordNode = $(view.passwordInput.getModel().element.rootElement);
